...
class AuthService {
  ...
  // Helper untuk Header Standar (JSON & Token)
  ...
  static Future<http.Response> verifyRegistration(String email, String otp) async => 
      await http.post(Uri.parse('$baseUrl/verify-registration'), 
      headers: _headers(), 
  ...
  // --- BERIKUT ADALAH FUNGSI YANG TADI HILANG ---
  ...
  static Future<http.Response> getQuestions(int tryoutId, String token) async => 
      await http.post(Uri.parse('$baseUrl/tryout/questions'), 
      headers: _headers(token), 
  ...
  static Future<http.Response> forgotPassword(String email) async => 
      await http.post(Uri.parse('$baseUrl/forgot-password'), 
      headers: _headers(), 
      body: jsonEncode({'email': email}));
  
  static Future<http.Response> resetPassword(Map<String, dynamic> data) async => 
      await http.post(Uri.parse('$baseUrl/reset-password'), 
      headers: _headers(), 
      body: jsonEncode(data));
